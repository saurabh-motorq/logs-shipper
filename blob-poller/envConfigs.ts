...
config.blobConfigs = [
...

    {
        ...
        fromDate: process.env.CLUTCHPROD_FROM_DATE || '2020-06-19T00:00:00.000Z', // we missed configuring this storage
    ...
    },
    {
        ...
        fromDate: process.env.DONLENDEMO_FROM_DATE || '2020-06-12T00:00:00.000Z', // we missed configuring this storage
    ...
    },
    {
        ...
        fromDate: process.env.ELEMENTDEMO_FROM_DATE || '2020-06-12T00:00:00.000Z', // we missed configuring this storage
    ...
    },
    {
        ...
        fromDate: process.env.LEONPROD_FROM_DATE || '2020-06-12T00:00:00.000Z', // we missed configuring this storage
    ...
    },
    {
        ...
        fromDate: process.env.LYNKDDEMO_FROM_DATE || '2020-06-12T00:00:00.000Z', // we missed configuring this storage
...
},
{
    ...
    fromDate: process.env.CLUTCHDEMO_FROM_DATE || '2020-06-19T00:00:00.000Z', // we missed configuring this storage
...
},
{
    ...
    fromDate: process.env.LEASEPLANDEMO_FROM_DATE || '2020-06-19T00:00:00.000Z', // we missed configuring this storage
...
},
{
    ...
    fromDate: process.env.WHEELSQA_FROM_DATE || '2020-06-19T00:00:00.000Z', // we missed configuring this storage
...
},
{
    ...
    fromDate: process.env.SUNPOWERPROD_FROM_DATE || '2020-06-19T00:00:00.000Z', // we missed configuring this storage
...
},
{
    ...
    folderPrefixes: [""], //update
    fromDate: process.env.CARLIQDEMO_FROM_DATE || '2020-06-19T00:00:00.000Z', // we missed configuring this storage
...
// }
{
    ...
    fromDate: process.env.UNIONDEMO_FROM_DATE || '2020-06-19T00:00:00.000Z', // we missed configuring this storage
...
},
{
    ...
    fromDate: process.env.WEXDEMO_FROM_DATE || '2020-06-19T00:00:00.000Z', // we missed configuring this storage
